...
from models.No_LayerNormV2_Count import TransformerEncoder, TransformerEncoderLayer
import torch.optim as optim
import matplotlib.pyplot as plt

# This is the training script for the 2-layer ReLU experiment (Appendix E) No-LayerNorm-Count.
    ...
    for epoch in range(num_epochs):
        ...
        if len(train_losses) >= 25:
            ...
            if mean_loss < best_loss:
                ...
                torch.save(model.state_dict(), 'No-LayerNormV2-Count.pt')
